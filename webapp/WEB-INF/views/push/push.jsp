...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/skeleton.css">

  
  <link rel="icon" type="image/png" href="${pageContext.request.contextPath}/assets/img/realtime-logo.jpg">
  ...
  <script src="${pageContext.request.contextPath}/assets/js/ChromePushManager.js"></script>  
  ...
  <div class="container">
    <div class="row">
      <div class="one-half column" style="margin-top: 2%">
        ...
        <p>
          <img src="${pageContext.request.contextPath}/assets/img/realtime-large-logo.jpg" style="max-width: 90%">
        </p>        
        ...
        <p>
          <img src="${pageContext.request.contextPath}/assets/img/push-notification.png" style="max-width: 90%; border: solid lightgray 1px;">
        </p>
      ...
      <div class="one-half column" style="margin-top: 10%">
        <img style="max-width: 90%; " src="${pageContext.request.contextPath}/assets/img/push2.gif">
      </div>
    </div>
  </div>
